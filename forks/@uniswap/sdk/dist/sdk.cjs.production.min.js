...
;((n = exports.ChainId || (exports.ChainId = {}))[(n.MAINNET = 1)] = 'MAINNET'),
  (n[(n.ROPSTEN = 3)] = 'ROPSTEN'),
  (n[(n.RINKEBY = 4)] = 'RINKEBY'),
  (n[(n['GÖRLI'] = 5)] = 'GÖRLI'),
  (n[(n.KOVAN = 42)] = 'KOVAN'),
...
var v,
  y = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f',
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
  ...
  W = (function(t) {
    function e() {
      ...
      return (
        ...
        M && Object.setPrototypeOf(B(n), (this instanceof e ? this.constructor : void 0).prototype),
        n
      )
    }
    return C(e, t), e
...
var tt,
  et,
  nt =
    (((J = {})[exports.ChainId.MAINNET] = new z(
    ...
    (J[exports.ChainId.ROPSTEN] = new z(
    ...
    (J[exports.ChainId.RINKEBY] = new z(
    ...
    (J[exports.ChainId.MUMBAI] = new z(
    ...
    return (
      ...
      (n.quote = function(e) {
        return (
          ...
          this.quoteCurrency instanceof z
            ? new pt(this.quoteCurrency, t.prototype.multiply.call(this, e.raw).quotient)
          ...
          (ft = P(
            ...
            (((u = {})[s[0].address] = P(
              ...
              (((i = {})[s[1].address] = a.getCreate2Address(
                '0xBd74CAF79af131Be929239C93C7143E4E7bCf8ED',
                d.keccak256(['bytes'], [d.pack(['address', 'address'], [s[0].address, s[1].address])]),
                y
              )),
              i)
            )),
    ...
    return (
      ...
      (e.getOutputAmount = function(e) {
        ...
        var n = this.reserveOf(e.token),
          ...
          c = new pt(e.token.equals(this.token0) ? this.token1 : this.token0, i.divide(a, s))
      ...
      (e.getInputAmount = function(e) {
        ...
        var n = this.reserveOf(e.token),
          ...
          s = new pt(e.token.equals(this.token0) ? this.token1 : this.token0, i.add(i.divide(o, a), g))
          ...
          if (i.equal(s, T)) a = e
            ...
            if (i.greaterThan(c, p)) {
              var d = i.multiply(e.raw, i.subtract(c, p)),
                ...
                l = i.divide(d, f)
              a = e.add(new pt(this.liquidityToken, l))
            } else a = e
          }
        } else a = e
        return new pt(t, i.divide(i.multiply(n.raw, this.reserveOf(t).raw), a.raw))
      }),
      R(t, [
        {
          key: 'token0Price',
  ...
  ht = (function() {
    function t(t, e, n) {
      t.length > 0 || u(!1),
        ...
        (e instanceof z && t[0].involvesToken(e)) || (e === $ && t[0].involvesToken(nt[t[0].chainId])) || u(!1),
        void 0 === n ||
          (n instanceof z && t[t.length - 1].involvesToken(n)) ||
          (n === $ && t[t.length - 1].involvesToken(nt[t[0].chainId])) ||
          u(!1)
      ...
      ;(this.pairs = t),
        (this.path = o),
        (this.midPrice = dt.fromRoute(this)),
        (this.input = e),
...
function Tt(t, e) {
  return t instanceof pt ? t : t.currency === $ ? new pt(nt[e], t.raw) : void u(!1)
}
function gt(t, e) {
  ...
  function t(t, e, n) {
    ...
    if (n === exports.TradeType.EXACT_INPUT) {
      ...
      for (var c = 0; c < t.path.length - 1; c++) {
        var p = t.pairs[c].getOutputAmount(a[c]),
          d = p[1]
        ;(a[c + 1] = p[0]), (s[c] = d)
      }
    } else {
    ...
    ;(this.route = t),
      (this.tradeType = n),
      (this.inputAmount = n === exports.TradeType.EXACT_INPUT ? e : t.input === $ ? ct.ether(a[0].raw) : a[0]),
      (this.outputAmount =
        n === exports.TradeType.EXACT_OUTPUT ? e : t.output === $ ? ct.ether(a[a.length - 1].raw) : a[a.length - 1]),
      (this.executionPrice = new dt(
        this.inputAmount.currency,
        this.outputAmount.currency,
        this.inputAmount.raw,
        this.outputAmount.raw
      )),
      (this.nextMidPrice = dt.fromRoute(new ht(s, t.input))),
      (this.priceImpact =
        ((r = this.outputAmount),
  ...
  return (
    ...
    (t.bestTradeExactIn = function(e, n, r, o, i, a, s) {
      ...
      void 0 === i && (i = []),
        ...
        l > 0 || u(!1),
        a === n || i.length > 0 || u(!1)
      var h = n instanceof pt ? n.token.chainId : r instanceof z ? r.chainId : void 0
      void 0 === h && u(!1)
      for (var m = Tt(n, h), v = gt(r, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            G(s, new t(new ht([].concat(i, [w]), a.currency, r), a, exports.TradeType.EXACT_INPUT), d, wt)
          else if (l > 1 && e.length > 1) {
            var k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactIn(k, g, r, { maxNumResults: d, maxHops: l - 1 }, [].concat(i, [w]), a, s)
          }
        }
      }
      return s
    ...
    (t.bestTradeExactOut = function(e, n, r, o, i, a, s) {
      ...
      void 0 === i && (i = []),
        ...
        l > 0 || u(!1),
        a === r || i.length > 0 || u(!1)
      var h = r instanceof pt ? r.token.chainId : n instanceof z ? n.chainId : void 0
      void 0 === h && u(!1)
      for (var m = Tt(r, h), v = gt(n, h), y = 0; y < e.length; y++) {
        ...
        if (
          ...
          if (g.token.equals(v))
            G(s, new t(new ht([w].concat(i), n, a.currency), a, exports.TradeType.EXACT_OUTPUT), d, wt)
          else if (l > 1 && e.length > 1) {
            var k = e.slice(0, y).concat(e.slice(y + 1, e.length))
            t.bestTradeExactOut(k, n, g, { maxNumResults: d, maxHops: l - 1 }, [w].concat(i), a, s)
          }
        }
      }
      return s
...
var At,
      ...
      (t.swapCallParameters = function(t, e) {
        ...
        switch (t.tradeType) {
          ...
          case exports.TradeType.EXACT_OUTPUT:
            l && u(!1),
              n
                ? ((o = 'swapETHForExactTokens'), (i = [p, d, s, f]), (a = c))
                : r
                ? ((o = 'swapTokensForExactETH'), (i = [p, c, d, s, f]), (a = '0x0'))
                : ((o = 'swapTokensForExactTokens'), (i = [p, c, d, s, f]), (a = '0x0'))
        }
  ...
  Ot = (((At = {})[exports.ChainId.MAINNET] = { '0xE0B7927c4aF23765Cb51314A0E0521A9645F0E2A': 9 }), At),
  bt = (function() {
    function t() {}
    return (
      (t.fetchTokenData = function(t, e, n, r, o) {
        try {
          ...
          var s =
            'number' ==
            typeof (null === (i = Ot) || void 0 === i || null === (u = i[t]) || void 0 === u ? void 0 : u[e])
          return Promise.resolve(
            s
              ? a(Ot[t][e])
              : Promise.resolve(
                  new f.Contract(e, Et, n).decimals().then(function(n) {
                    var r, o, i
                    return (
                      (Ot = P(
                        {},
      ...
      (t.fetchPairData = function(t, e, n) {
        try {
          ...
          return Promise.resolve(new f.Contract(r, m.abi, n).getReserves()).then(function(n) {
            ...
            return new lt(new pt(t, i[0]), new pt(e, i[1]))
          })
        } catch (t) {
          return Promise.reject(t)
        }
...
;(exports.JSBI = i),
  ...
  (exports.ETHER = $),
  (exports.FACTORY_ADDRESS = '0xBd74CAF79af131Be929239C93C7143E4E7bCf8ED'),
  (exports.Fetcher = bt),
  (exports.Fraction = at),
  (exports.INIT_CODE_HASH = y),
  (exports.InsufficientInputAmountError = L),
  (exports.InsufficientReservesError = W),
