...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    text5: darkMode ? '#2C2F36' : '#e0d6e6',

    // backgrounds / greys
    bg1: darkMode ? '#212429' : '#FFFFFF',
    bg2: darkMode ? '#2C2F36' : '#f4f2ff',
    bg3: darkMode ? '#40444F' : '#e0d6e6',
    ...
    //primary colors
    primary1: darkMode ? '#2172E5' : '#6b4980',
    primary2: darkMode ? '#3680E7' : '#88715f',
    primary3: darkMode ? '#4D8FEA' : '#aa9585',
    primary4: darkMode ? '#376bad70' : '#e2d6cf',
    primary5: darkMode ? '#153d6f70' : '#eee7f0',

    // color text
    primaryText1: darkMode ? '#6da8ff' : '#6b4980',

    // secondary colors
    secondary1: darkMode ? '#2172E5' : '#6b4980',
    secondary2: darkMode ? '#17000b26' : '#e2d6cf',
    secondary3: darkMode ? '#17000b26' : '#eee7f0',
